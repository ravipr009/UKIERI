...
#ifndef INITIALIZER_EXOTICA_AICO_SOLVER_AICO_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_AICO_SOLVER_AICO_SOLVER_INITIALIZER_H
...
class AICOSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/AICOSolver" ;}

    AICOSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        SweepMode( "Symmetric") ,
    ...
    AICOSolverInitializer(const Initializer& other) : AICOSolverInitializer()
    {
    ...
    {
        return (Initializer)AICOSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer AICOSolverInitializer requires property Name to be set!");
    }
