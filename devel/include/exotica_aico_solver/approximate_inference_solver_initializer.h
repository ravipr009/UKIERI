...
#ifndef INITIALIZER_EXOTICA_AICO_SOLVER_APPROXIMATE_INFERENCE_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_AICO_SOLVER_APPROXIMATE_INFERENCE_SOLVER_INITIALIZER_H
...
class ApproximateInferenceSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/ApproximateInferenceSolver" ;}

    ApproximateInferenceSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        SweepMode( "Symmetric") ,
    ...
    ApproximateInferenceSolverInitializer(const Initializer& other) : ApproximateInferenceSolverInitializer()
    {
    ...
    {
        return (Initializer)ApproximateInferenceSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer ApproximateInferenceSolverInitializer requires property Name to be set!");
    }
