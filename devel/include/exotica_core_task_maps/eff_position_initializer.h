...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_POSITION_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_POSITION_INITIALIZER_H
...
class EffPositionInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/EffPosition" ;}

    EffPositionInitializer() : InitializerBase(),
        Debug( false) ,
        EndEffector( std::vector<exotica::Initializer>()) 
    {
    }

    EffPositionInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    EffPositionInitializer(const Initializer& other) : EffPositionInitializer()
    {
    ...
    {
        return (Initializer)EffPositionInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer EffPositionInitializer requires property Name to be set!");
    }
