...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_VELOCITY_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_VELOCITY_INITIALIZER_H
...
class EffVelocityInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/EffVelocity" ;}

    EffVelocityInitializer() : InitializerBase(),
        Debug( false) ,
        EndEffector( std::vector<exotica::Initializer>()) 
    {
    }

    EffVelocityInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    EffVelocityInitializer(const Initializer& other) : EffVelocityInitializer()
    {
    ...
    {
        return (Initializer)EffVelocityInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer EffVelocityInitializer requires property Name to be set!");
    }
