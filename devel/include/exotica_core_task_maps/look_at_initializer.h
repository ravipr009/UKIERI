...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_LOOK_AT_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_LOOK_AT_INITIALIZER_H
...
class LookAtInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/LookAt" ;}

    LookAtInitializer() : InitializerBase(),
        Debug( false) ,
        EndEffector( std::vector<exotica::Initializer>()) 
    {
    }

    LookAtInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    LookAtInitializer(const Initializer& other) : LookAtInitializer()
    {
    ...
    {
        return (Initializer)LookAtInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer LookAtInitializer requires property Name to be set!");
    }
