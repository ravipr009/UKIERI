...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_ACCELERATION_BACKWARD_DIFFERENCE_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_ACCELERATION_BACKWARD_DIFFERENCE_INITIALIZER_H
...
class JointAccelerationBackwardDifferenceInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/JointAccelerationBackwardDifference" ;}

    JointAccelerationBackwardDifferenceInitializer() : InitializerBase(),
        Debug( false) ,
    ...
    JointAccelerationBackwardDifferenceInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>(), Eigen::VectorXd _StartState =  Eigen::VectorXd()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    JointAccelerationBackwardDifferenceInitializer(const Initializer& other) : JointAccelerationBackwardDifferenceInitializer()
    {
    ...
    {
        return (Initializer)JointAccelerationBackwardDifferenceInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer JointAccelerationBackwardDifferenceInitializer requires property Name to be set!");
    }
