...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_FRAME_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_FRAME_INITIALIZER_H
...
class EffFrameInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/EffFrame" ;}

    EffFrameInitializer() : InitializerBase(),
        Debug( false) ,
    ...
    EffFrameInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>(), std::string _Type =  "RPY") : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    EffFrameInitializer(const Initializer& other) : EffFrameInitializer()
    {
    ...
    {
        return (Initializer)EffFrameInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer EffFrameInitializer requires property Name to be set!");
    }
