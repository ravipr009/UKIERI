...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_JERK_BACKWARD_DIFFERENCE_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_JERK_BACKWARD_DIFFERENCE_INITIALIZER_H
...
class JointJerkBackwardDifferenceInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/JointJerkBackwardDifference" ;}

    JointJerkBackwardDifferenceInitializer() : InitializerBase(),
        Debug( false) ,
    ...
    JointJerkBackwardDifferenceInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>(), Eigen::VectorXd _StartState =  Eigen::VectorXd()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    JointJerkBackwardDifferenceInitializer(const Initializer& other) : JointJerkBackwardDifferenceInitializer()
    {
    ...
    {
        return (Initializer)JointJerkBackwardDifferenceInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer JointJerkBackwardDifferenceInitializer requires property Name to be set!");
    }
