...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_BOX_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_EFF_BOX_INITIALIZER_H
...
class EffBoxInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/EffBox" ;}

    EffBoxInitializer() : InitializerBase(),
        Debug( false) ,
        EndEffector( std::vector<exotica::Initializer>()) 
    {
    }

    EffBoxInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    EffBoxInitializer(const Initializer& other) : EffBoxInitializer()
    {
    ...
    {
        return (Initializer)EffBoxInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer EffBoxInitializer requires property Name to be set!");
    }
