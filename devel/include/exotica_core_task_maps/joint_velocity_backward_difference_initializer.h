...
#ifndef INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_VELOCITY_BACKWARD_DIFFERENCE_INITIALIZER_H
#define INITIALIZER_EXOTICA_CORE_TASK_MAPS_JOINT_VELOCITY_BACKWARD_DIFFERENCE_INITIALIZER_H
...
class JointVelocityBackwardDifferenceInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/JointVelocityBackwardDifference" ;}

    JointVelocityBackwardDifferenceInitializer() : InitializerBase(),
        Debug( false) ,
    ...
    JointVelocityBackwardDifferenceInitializer( std::string _Name, bool _Debug =  false, std::vector<exotica::Initializer> _EndEffector =  std::vector<exotica::Initializer>(), Eigen::VectorXd _StartState =  Eigen::VectorXd()) : InitializerBase(),
        Name(_Name) ,
        Debug(_Debug) ,
    ...
    JointVelocityBackwardDifferenceInitializer(const Initializer& other) : JointVelocityBackwardDifferenceInitializer()
    {
    ...
    {
        return (Initializer)JointVelocityBackwardDifferenceInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer JointVelocityBackwardDifferenceInitializer requires property Name to be set!");
    }
