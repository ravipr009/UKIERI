...
#ifndef INITIALIZER_EXOTICA_DDP_SOLVER_ANALYTIC_DDP_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_DDP_SOLVER_ANALYTIC_DDP_SOLVER_INITIALIZER_H
...
class AnalyticDDPSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/AnalyticDDPSolver" ;}

    AnalyticDDPSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
    ...
    AnalyticDDPSolverInitializer(const Initializer& other) : AnalyticDDPSolverInitializer()
    {
    ...
    {
        return (Initializer)AnalyticDDPSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer AnalyticDDPSolverInitializer requires property Name to be set!");
    }
