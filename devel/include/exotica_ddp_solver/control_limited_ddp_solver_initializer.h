...
#ifndef INITIALIZER_EXOTICA_DDP_SOLVER_CONTROL_LIMITED_DDP_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_DDP_SOLVER_CONTROL_LIMITED_DDP_SOLVER_INITIALIZER_H
...
class ControlLimitedDDPSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/ControlLimitedDDPSolver" ;}

    ControlLimitedDDPSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
    ...
    ControlLimitedDDPSolverInitializer(const Initializer& other) : ControlLimitedDDPSolverInitializer()
    {
    ...
    {
        return (Initializer)ControlLimitedDDPSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer ControlLimitedDDPSolverInitializer requires property Name to be set!");
    }
