...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_LAZY_PRM_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_LAZY_PRM_SOLVER_INITIALIZER_H
...
class LazyPRMSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/LazyPRMSolver" ;}

    LazyPRMSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    LazyPRMSolverInitializer(const Initializer& other) : LazyPRMSolverInitializer()
    {
        ...
        if (other.HasProperty("MultiQuery")) {const Property& prop=other.properties_.at("MultiQuery"); if(prop.IsSet()) MultiQuery = prop.IsStringType()?ParseBool(boost::any_cast<std::string>(prop.Get())):boost::any_cast<bool>(prop.Get());}
    }

    virtual Initializer GetTemplate() const
    {
        return (Initializer)LazyPRMSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer LazyPRMSolverInitializer requires property Name to be set!");
    }
    ...
    operator Initializer()
    {
        ...
        ret.properties_.emplace("MultiQuery", Property("MultiQuery", false, boost::any(MultiQuery)));
        return ret;
    }
