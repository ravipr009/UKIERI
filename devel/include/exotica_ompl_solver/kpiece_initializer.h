...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_KPIECE_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_KPIECE_SOLVER_INITIALIZER_H
...
class KPIECESolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/KPIECESolver" ;}

    KPIECESolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    KPIECESolverInitializer(const Initializer& other) : KPIECESolverInitializer()
    {
    ...
    {
        return (Initializer)KPIECESolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer KPIECESolverInitializer requires property Name to be set!");
    }
