...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_PRM_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_PRM_SOLVER_INITIALIZER_H
...
class PRMSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/PRMSolver" ;}

    PRMSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    PRMSolverInitializer(const Initializer& other) : PRMSolverInitializer()
    {
    ...
    {
        return (Initializer)PRMSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer PRMSolverInitializer requires property Name to be set!");
    }
