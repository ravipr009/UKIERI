...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_LBTRRT_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_LBTRRT_SOLVER_INITIALIZER_H
...
class LBTRRTSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/LBTRRTSolver" ;}

    LBTRRTSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    LBTRRTSolverInitializer(const Initializer& other) : LBTRRTSolverInitializer()
    {
    ...
    {
        return (Initializer)LBTRRTSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer LBTRRTSolverInitializer requires property Name to be set!");
    }
