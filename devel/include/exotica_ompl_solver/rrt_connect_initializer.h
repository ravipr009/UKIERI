...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_RRT_CONNECT_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_RRT_CONNECT_SOLVER_INITIALIZER_H
...
class RRTConnectSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/RRTConnectSolver" ;}

    RRTConnectSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    RRTConnectSolverInitializer(const Initializer& other) : RRTConnectSolverInitializer()
    {
    ...
    {
        return (Initializer)RRTConnectSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer RRTConnectSolverInitializer requires property Name to be set!");
    }
