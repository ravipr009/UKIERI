...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_RRT_STAR_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_RRT_STAR_SOLVER_INITIALIZER_H
...
class RRTStarSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/RRTStarSolver" ;}

    RRTStarSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    RRTStarSolverInitializer(const Initializer& other) : RRTStarSolverInitializer()
    {
    ...
    {
        return (Initializer)RRTStarSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer RRTStarSolverInitializer requires property Name to be set!");
    }
