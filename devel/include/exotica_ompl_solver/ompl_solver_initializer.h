...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_OMPL_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_OMPL_SOLVER_INITIALIZER_H
...
class OMPLSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/OMPLSolver" ;}

    OMPLSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    OMPLSolverInitializer(const Initializer& other) : OMPLSolverInitializer()
    {
    ...
    {
        return (Initializer)OMPLSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer OMPLSolverInitializer requires property Name to be set!");
    }
