...
#ifndef INITIALIZER_EXOTICA_OMPL_SOLVER_EST_SOLVER_INITIALIZER_H
#define INITIALIZER_EXOTICA_OMPL_SOLVER_EST_SOLVER_INITIALIZER_H
...
class ESTSolverInitializer : public InitializerBase
{
public:
    static std::string GetContainerName() {return "exotica/ESTSolver" ;}

    ESTSolverInitializer() : InitializerBase(),
        Debug( false) ,
        MaxIterations( 100) ,
        Smooth( true) ,
        ReduceVertices( true) ,
    ...
    ESTSolverInitializer(const Initializer& other) : ESTSolverInitializer()
    {
    ...
    {
        return (Initializer)ESTSolverInitializer();
    }
    ...
    {
        if(!other.HasProperty("Name") || !other.properties_.at("Name").IsSet()) ThrowPretty("Initializer ESTSolverInitializer requires property Name to be set!");
    }
